...
namespace Common
{
    ...
    {
        static ILogger log = LogManager.GetLogger(typeof(HttpClientHelper));
        ...
        public static string GetResponse(string url)
        {
            ...
            try
            {
                ...
                httpClient.CancelPendingRequests();
                httpClient.DefaultRequestHeaders.Clear();
                //httpClient.DefaultRequestHeaders.Add("Cookie", "ASP.NET_SessionId=w4cigygqqzojgubjqjkjhkfk");
                httpClient.DefaultRequestHeaders.Accept.Add(
                   new MediaTypeWithQualityHeaderValue("application/json"));
                Task<HttpResponseMessage> taskResponse = httpClient.GetAsync(url);
                taskResponse.Wait();
        ...
        public static string PostResponse(string url, object obj)
        {
            ...
            try
            {
                ...
                {
                    log.Error("结果：" + response.StatusCode + "内容：" + JsonConvertTool.SerializeObject(obj));
                }
                return null;
            }
            catch (Exception exception)
            {
                log.Error("结果：异常 内容：" + JsonConvertTool.SerializeObject(obj) + "ex:" + exception.Message,exception);
                return null;
            }
            finally
            {
